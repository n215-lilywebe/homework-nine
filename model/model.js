...
<div class="content">
    <div class="mission">
        ...
        <div class="mission-text">
            <h3>our mission</h3>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab dolorem consequatur assumenda numquam
                eligendi consectetur quia quae perferendis dolorum saepe eos tempore voluptate, velit fuga
                voluptatum sed laboriosam. Repellat, molestias?</p>
        </div>
    </div>
    <div class="commitment">
        <h3>our commitment to our employees</h3>
        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Molestiae, dolore modi? Minima, quaerat
            omnis, veniam cum repudiandae exercitationem deleniti explicabo quisquam facilis quos a dicta, iusto
            nesciunt consectetur corporis eos.</p>
    </div>
    <div class="our-founders">
        <div class="founders-bio">
            <h3>our founders</h3>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima, asperiores labore eligendi,
                necessitatibus pariatur tempore qui quasi quod accusantium veritatis dolorum at, voluptatibus
                eum! Laudantium quos cupiditate beatae illum ipsam?</p>
        </div>
